...
(function(app) {
  ...
  var RequestsErrorHandler = ['$q', function($q) {
    return {
  ...
  var Config = ['$provide', '$httpProvider', function($provide, $httpProvider) {
  ...
  app.factory('RequestsErrorHandler', RequestsErrorHandler);
  app.config(Config);
